                          ...
                          children: [
                            Container(
                              ...
                              child: CircularProgressIndicator(
                                ...
                                strokeWidth: 10.0, // Adjust the thickness of the circular line
                                backgroundColor: Colors.transparent, // Make the background color transparent
                                valueColor: AlwaysStoppedAnimation<Color>(Colors.white), // Glow white color
                              ),
                            ),
                            Align(
                              alignment: Alignment.center,
        ...
        child: Stack(
          ...
          children: [
            ...
            Align(
              alignment: Alignment.centerLeft,
              child: Padding(
                padding: EdgeInsets.only(left: 17.h, top: 8.v), // Adjusted top padding
                child: Text(
                  "lbl_craft".tr,
