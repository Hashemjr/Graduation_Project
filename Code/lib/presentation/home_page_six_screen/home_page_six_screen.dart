import 'bloc/home_page_six_bloc.dart';
import 'models/home_page_six_model.dart';
...
class HomePageSixScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
                      ...
                      child: Column(
                        children: [
                          ...
                          Padding(
                            ...
                            child: BlocSelector<HomePageSixBloc,
                                HomePageSixState, TextEditingController?>(
        ...
        bottomNavigationBar: _buildMenu1BottomAppBar(context),
  ...
  /// Section Widget
  Widget _buildMenu1BottomAppBar(BuildContext context) {
